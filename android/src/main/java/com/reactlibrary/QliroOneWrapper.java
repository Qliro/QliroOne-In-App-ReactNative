...
public class QliroOneWrapper extends LinearLayout {
    ...
    public QliroOneWrapper(ThemedReactContext context, AttributeSet attrs) {
        ...
        qliroOneCheckout = new QliroOneCheckout(getReactAppContext().getCurrentActivity(), attrs, "0.1.17"); // Ensure we use activity and not application context for dialogs.
